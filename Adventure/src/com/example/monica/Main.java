...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        locations.put(1, new Location(1, "You are standing at the end of a road by a building"));
        locations.put(2, new Location(2, "You are on top of a hill"));
        locations.put(3, new Location(3, "You are inside a well house for a small spring"));
        locations.put(4, new Location(4, "You are in a valley by a stream"));
