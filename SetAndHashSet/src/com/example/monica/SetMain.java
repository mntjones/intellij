...
public class SetMain {
    ...
    public static void main(String[] args) {
        ...
        // bulk operations are destructive
        union.addAll(cubes);
        ...
        // going to look at sets with asymmetric differences
        ...
        System.out.println("intersectionTest contains: ");
        printSet(intersectionTest);
        System.out.println();

        // containsAll not destructive - returns boolean
